    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <header className="border-b bg-white">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <Link 
              href="http://localhost:3000/farmer/register"
              className="text-green-600 px-6 py-2 rounded-lg hover:bg-green-50 font-medium"
            >
              Sign In
            </Link>
            <Link 
      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <Link 
            href="http://localhost:3000/farmer/register"
            className="inline-block bg-green-600 text-white px-8 py-3 rounded-lg text-lg hover:bg-green-700"
          >
            Get Started
          </Link>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-4 gap-6">
          ...
          <div className="mt-16 bg-gradient-to-r from-green-600 to-green-700 rounded-lg p-12 text-center text-white">
            ...
            <Link 
              href="http://localhost:3000/farmer/register"
              className="inline-block bg-white text-green-600 px-8 py-4 rounded-lg text-lg font-bold hover:bg-gray-100 transition-colors"
            >
              Start Selling Today →
            </Link>
          </div>
        ...
        <div className="text-center mt-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <Link
              href="http://localhost:3000/farmer/dashboard"
